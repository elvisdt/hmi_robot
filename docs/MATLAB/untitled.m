%% --- Animaci  n SCARA-CNC usando Cinem  tica Inversa y Directa ---
clc; clear; close all;
...
for i = 2:skip:length(TrayFinal)
    ...
    % --- Obtener posici  n del robot usando cinem  tica directa ---
    ...
    % calcular tiempo de pausa seg  n velocidad
...
disp('    Animaci  n SCARA-CNC completa.');
