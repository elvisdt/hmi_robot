...
% CINEMATICAINVERSA - Convierte trayectorias cartesianas a angulos y desplazamientos articulares (P-R-R)
% Entradas:
...
%   TrayArt - Nx5 [d1 theta2 theta3 flag velocidad]
    ...
    for i=1:n
        ...
        % --- CALCULO DE CINEMATICA INVERSA (NO CAMBIA) ---
        
        % 1. Articulacion Prismatica (d1):
        d1 = Z;
        
        % 2. Calculo de angulos Rotacionales (theta2 y theta3) en el plano XY:
        r_sq = X^2 + Y^2;
        r = sqrt(r_sq);
