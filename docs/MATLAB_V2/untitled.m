%% --- Animacion SCARA-CNC usando Cinematica Inversa y Directa ---
clc; clear; close all;
...
for i = 2:skip:length(TrayFinal)
    ...
    % --- Obtener posicion del robot usando cinematica directa ---
    ...
    % calcular tiempo de pausa segun velocidad
