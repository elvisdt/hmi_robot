...
% Entradas:
%   q, dq    - Posicion y velocidad articulares [d1; th2; th3]
%   params   - Estructura con parametros dinamicos (L1, L2, m1, m2, m3, I2, I3, g)

    % 0. Extraccion de Parametros y Variables
    ...
    % --- C: Matriz de Coriolis y Centrifuga (3x3) ---
    C = zeros(3,3);
    h = -m3*L1*Cm_L2*s3;
    C(2,2) = h * dth3;
    C(2,3) = h * (dth2 + dth3);
