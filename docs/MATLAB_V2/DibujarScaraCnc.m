%% --- Funcion DibujarScaraCnc lista para animacion ---
function handles = DibujarScaraCnc(ax, pos, handles)
    % pos = [O; P; A; B] -> O=base, P=prismatico, A=brazo1, B=brazo2/efector
    O = pos(1,:);  % Base
    P = pos(2,:);  % Esbelon prismatico (vertical)
    ...
    if createNew
        ...
        % Primer eslabon prismatico (gris)
