...
%% --- Parametros del robot (Ejemplo) ---
L1 = 0.6;   % mm
L2 = 0.65;  % mm

%% --- Parametros de trayectoria (Ejemplo) ---
Z_home = 200;   % altura de guardado [mm]
Z_cut  = 150;  % altura de corte [mm]
paso   = 1;     % resolucion de interpolacion [mm] <--- AHORA EN MM
ratio  = 0.3;
...
if isequal(archivo,0), error('No se selecciono archivo'); end
...
%% --- Cinematica directa vectorizada ---
...
% title('Animacion SCARA-P-R-R con Trayectoria');
% view(45,30);
% 
% % Limites del eje
% Ltot = L1 + L2;
...
% 
% % Dibujar trayectoria de referencia (linea fina)
...
% 
%     % Posiciones de la cinematica directa
