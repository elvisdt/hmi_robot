...
% FLAG KEY: 1=Corte (a Z_cut), 2=Reposo (a Z_home), 3=Traslado Seguro (a Z_home).
    ...
    % --- 1. PREPARACION DE GRUPOS VALIDOS (Filtrado de FLAG=0) ---
    GruposValidos = {};
    ...
    for k = 1:length(GruposValidos)
        ...
        % Limpieza de NaNs y logica de Z constante
        ...
        % --- Calculo de largo acumulado y Interpolacion ---
